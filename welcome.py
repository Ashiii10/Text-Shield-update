...
def welcome_screen():
    st.markdown("""
        ...
        .wind2 { top: 70px; animation-delay: 1.1s; }
        .wind3 { top: 100px; animation-delay: 2.2s; }
        @keyframes windmove {
        ...
        @keyframes flyInGlow {
            0% { transform: translateX(-200px) scale(0.5); opacity: 0; filter: none; }
            60% { transform: translateX(20px) scale(1.1); opacity: 1; }
            100% { transform: translateX(0) scale(1); opacity: 1; filter: drop-shadow(0 0 15px #00fff7); }
        }
        .robot-img {
            width: 110px;
        ...
        .logo-gif { width: 60px; transition: transform 0.3s ease; }
        .logo-gif:hover { transform: scale(1.05); }
        .typewriter h1 {
            overflow: hidden;
        ...
        .subtitle { font-size: 18px; text-align: center; margin-top: 20px; }
        @media screen and (max-width: 768px) {
            .robot-row { flex-direction: column; gap: 10px; }
